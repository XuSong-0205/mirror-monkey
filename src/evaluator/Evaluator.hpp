...
class Evaluator {
  ...
  public:
    ...
    shared_ptr<Object> eval_for_statement(ForStatement* fs, Environment* env);
    shared_ptr<Object> eval_block_statement(BlockStatement* block, Environment* env);

    bool is_truthy(Object* obj);
    bool is_error(shared_ptr<Object> obj);

    vector<shared_ptr<Object>> eval_expressions(vector<unique_ptr<Expression>> &exps, Environment *env);
    shared_ptr<Object> apply_function(shared_ptr<Object> fn, vector<shared_ptr<Object>> args);
    shared_ptr<Environment> extend_function_env(Function *fn, vector<shared_ptr<Object>> args);
    shared_ptr<Object> unwrap_return_value(shared_ptr<Object> obj);

    shared_ptr<Object> eval_string_infix_expression(string op, Object *left, Object *right);
